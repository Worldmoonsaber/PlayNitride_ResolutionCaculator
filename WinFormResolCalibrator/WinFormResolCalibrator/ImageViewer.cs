    ...
    public partial class KpImageViewer : UserControl
    {
        ...
        private void pbFull_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    // Fancy cursor
                    pbFull.Cursor = new Cursor("Resource//ruler.ico");
                ...
                {
                    pbFull.Cursor = new Cursor("Resource//Grab.cur");
                    // Start dragging
        ...
        {
            KP_ImageViewerV2_Resize(null, null);
        }

        private void tsmiStatusChange_Click(object sender, EventArgs e)
        {
            tsmiDrag.Checked = false;
            tsmiMeasure.Checked = false;
